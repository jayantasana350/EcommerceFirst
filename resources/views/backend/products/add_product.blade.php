        ...
        <form action="{{ route('ProductStore') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mg-b-25">
                ...
                <div class="col-lg-12">
                    ...
                    <input class="form-control" type="text" name="sku" value="" placeholder="Enter Title">
                    </div>
                </div><!-- col-4 -->
                <div class="col-lg-6">
                    ...
                    <tbody>
                        <tr class="d-flex">
                            <td class="col-lg-5">
                                ...
                                <input class="form-control" type="number" name="product_upc[]" value="" placeholder="Enter SKU">
                                </div>
                            </td><!-- col-4 -->
                            <td class="col-lg-5">
                                <div class="form-group">
            ...
            <div class="col-lg-12 mg-t-20">
                ...
                <textarea class="form-control" name="summery" id="summery" rows="5"></textarea>
                </div>
            </div><!-- col-12 -->
            <div class="col-lg-12 mg-t-20">
                <div class="form-group mg-b-10-force">
                <label class="form-control-label">Descritpion: <span class="tx-danger">*</span></label>
                <textarea class="form-control" name="descripiton" id="" rows="10"></textarea>
                </div>
            </div><!-- col-12 -->
            <div class="col-lg-12 mg-t-20">
                <div class="form-group mg-b-10-force">
                <label class="form-control-label">Thumbnail Image: <span class="tx-danger">*</span></label>
                <input class="form-control" type="file" name="thumbnail" onchange="readURL(this);">
            ...
            <div class="col-lg-12 mg-t-20">
                ...
                <input type="file" class="form-control" name="image[]" id="image" multiple="multiple" onchange="readURL(this);">
            </div>
            </div><!-- col-12 -->
            </div><!-- row -->
