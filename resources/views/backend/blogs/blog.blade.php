    ...
    <div class="br-section-wrapper">
        ...
        <div class="container hidden">
            <ul  class="nav nav-pills">
                        <li class="active"><a href="" data-target="#category" class="btn btn-info mr-1" data-toggle="tab">All Blogs</a></li>
                    ...
                    <div class="tab-content hidden">
                        <div class="tab-pane active" id="category">
                          ...
                          <a href="" style="display:inline; float: right; " class="btn btn-outline-info mb-1 mr-1" data-toggle="modal" data-target="#AddCategory">Add New Blog</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content p-3" style="width: 600px">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLongTitle">Add a New Blog</h5>
                                    ...
                                    <div class="form-layout form-layout-12">
                                        <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label">Catetory: <span class="tx-danger">*</span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                  <select name="category_id" id="category_id" class="form-control">
                                                      @foreach ($categories as $catetory)
                                                      <option value="{{ $catetory->id }}">{{ $catetory->category_name }}</option>
                                                      @endforeach
                                                  </select>
                                                </div>
                                                </div>
                                            <div class="row mg-t-20">
                                            <label for="my-editor" class="col-sm-4 form-control-label">Summery: <span class="tx-danger">*</span></label>
                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                              <textarea name="summery" id="my-editor" class="form-control" placeholder="Enter Category Descritpin"></textarea>
                                            </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label">Image: <span class="tx-danger">*</span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                  <input type="file" name="thumbnail" id="slug" class="form-control" placeholder="Enter slug">
                                                </div>
                                            </div>
                          ...
                          <table class="table table-bordered table-colored table-info">
                            <thead>
                              <tr>
                                ...
                                <th class="wd-10p text-center">Title</th>
                                <th class="wd-35p text-center">Summery</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="wd-10p text -center">{{ $blogs->firstItem() + $key }}</td>
                                    <td class="wd-35p text-center">{{ $blog->title }}</td>
                                    <td class="wd-35p text-center">{{ $blog->summery }}</td>
                                    <td class="wd-20p text-center">{{ $blog->slug ?? 'NA' }}</td>
                                    <td class="wd-20p text-center"><img src="{{ asset('images/' . $blog->thumbnail) }}" alt=""></td>
                                    <td class="wd-20p text-center d-flex">
                                        <a href="" class="btn btn-info mr-1" data-toggle="modal" data-target="#EditCategory{{ $blog->id }}">Edit</a>
                                        <a href="{{-- {{ route('destroy', $blog->id) }}--}}" class="btn btn-danger">Delete</a>
                                        <div class="modal fade" id="EditCategory{{ $blog->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-layout form-layout-12">
                                                        <form action="{{ route('CategoryUpdate') }}" method="POST">
                                                            ...
                                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                                <input type="text" name="category_name" class="form-control" value="{{ $blog->category_name }}" placeholder="Enter Category Name">
                                                            </div>
                                                            </div><!-- row -->
                                                            <div class="row mg-t-20">
                                                            <label class="col-sm-4 form-control-label">Description: <span class="tx-danger">*</span></label>
                                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                              <textarea name="description" id="category_description" value="{{ $blog->description }}" class="form-control" placeholder="Enter Category Descritpin">{{ $blog->description }}</textarea>
                                                            </div>
                                                            </div>
                                                            <div class="row mg-t-20">
                                                              <label class="col-sm-4 form-control-label">Slug: <span class="tx-danger">*</span></label>
                                                              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                                <input type="text"  value="{{ $blog->slug }}" name="slug" id="slug" class="form-control" placeholder="Enter slug">
                                                              </div>
                                                              </div>
                                                            <div class="form-layout-footer mg-t-30 text-center">
                                                            <button class="btn btn-info" style="cursor: pointer;">Add Ctegory</button>
                        ...
                        <div class="tab-pane" id="trushed">
                            ...
                            <tbody>
                                <tr>
                                    <td class="wd-10p text-center"></td>
                                    <td class="wd-35p text-center"></td>
                                    <td class="wd-35p text-center"></td>
                                    {{-- <td class="wd-35p text-center"></td> --}}
                                    <td class="wd-35p text-center"></td>
                                    <td class="wd-20p text-center"></td>
                                    <td class="wd-20p text-center d-flex">
                                        <a href="" class="btn btn-info mr-1">Restore</a>
                                        <a href="" class="btn btn-danger">Parmanent Delete</a>
                                    </td>
                                </tr>
                            </tbody>
                            </table>
