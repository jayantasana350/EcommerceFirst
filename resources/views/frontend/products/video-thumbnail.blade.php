                ...
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        <div class="product-service">
                            <div class="media">
                                <svg>
                                    <use xlink:href="http://themes.pixelstrap.com/multikart/assets/svg/icons.svg#returnable"></use>
                                </svg>
                            ...
                            <div class="media">
                                <svg>
                                    <use xlink:href="http://themes.pixelstrap.com/multikart/assets/svg/icons.svg#warranty"></use>
                                </svg>
                                <div class="media-body">
                            ...
                            <div class="col-lg-6">
                                <div class="product-slick">
                                    ...
                                    <div class="video-product">
                                        <iframe src="https://www.youtube.com/embed/gyGsPlt06bo" frameborder="0"
                            ...
                            <div class="col-lg-6 rtl-text">
                                <div class="product-right">
                                    ...
                                    <div class="product-count">
                                        <ul>
                                            <li>
                                                <img src="../assets/images/icon/truck.png" class="img-fluid"
                                                    alt="image">
